...
namespace MobaServer.Dao.Model
{
    /// <summary>
    /// 类USER
    /// </summary>
    ...
    public partial class USER
    {
        ...
        public USER(int accountId)
        {
            ...
            strSql.Append("select id,name,level,exp,winCount,loseCount,runCount,accountId,heroList ");
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                {
                    this.heroList = (int[])Serializer.Decode((byte[])ds.Tables[0].Rows[0]["heroList"]);
                }
            }
        }
        ...
        public void Add()
        {
            ...
            strSql.Append("name,level,exp,winCount,loseCount,runCount,accountId,heroList)");
            strSql.Append(" values (");
            strSql.Append("@name,@level,@exp,@winCount,@loseCount,@runCount,@accountId,@heroList)");
            MySqlParameter[] parameters = {
                    new MySqlParameter("@name", MySqlDbType.VarChar,255),
                    new MySqlParameter("@level", MySqlDbType.Int16,4),
            ...
            parameters[3].Value = winCount;
            parameters[4].Value = loseCount;
            parameters[5].Value = runCount;
            parameters[6].Value = accountId;
            parameters[7].Value = Serializer.Encode(heroList);
